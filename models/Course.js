...
const CourseSchema = new mongoose.Schema({
  ...
  // This basically says that the bootcamp is a reference to another document based on the ID and it is used to tie a course to a specific bootcamp. This is also necessary if we want to use populate().
  bootcamp: {
